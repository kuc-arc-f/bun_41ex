...
export const itemsApi = {
  getAll: async (content: string): Promise<Item[]> => {
    const response = await fetch(`/api/sort/list`, {
      method: 'POST',
      headers: {
  ...
  create: async (item: NewItem): Promise<Item> => {
    console.log(item);
    const response = await fetch("/api/sort/create", {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  update: async (id: number, item: Partial<NewItem>): Promise<Item> => {
    item.id = id;
    const response = await fetch(`/api/sort/update`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  delete: async (id: number): Promise<void> => {
    const item = { id: id }
    const response = await fetch(`/api/sort/delete`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
